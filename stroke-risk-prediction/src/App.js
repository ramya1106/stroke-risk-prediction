...
function App() {
  ...
  return (
    <div className="app-container">
      <h1 className="main-heading">Stroke Risk Prediction</h1>
      <div className="form-container">
        <div className="side-bar">
          <div className="text-container">
            <h1>Know Your Heart Better</h1>
            <p>
              Fill in a few simple details and get a quick, personalized view of
              your heart health. Awareness is the first step to prevention.
            </p>
          </div>
          <img
